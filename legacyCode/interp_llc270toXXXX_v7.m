function [fieldOut] = interp_llc270toXXXX_v7(fieldIn, ...
							flagXX, flagNZ, flaghFac, nx, drF0, drF1)

%------------
% function [fieldout]=interp_llc270toXXXX_v7(fieldIn,flagXX,flagNZ,flagFac,nx,drF0,drF1)
