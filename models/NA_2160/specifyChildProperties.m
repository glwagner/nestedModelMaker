...
dirz.childBathy = '/net/barents/raid16/atnguyen/llc2160/global/bathy2160_g5_r4';

dirz.childGlobalGrids = ['/net/barents/raid16/weddell/raid3/gforget/grids/', ...
    'gridCompleted/llcRegLatLon/llc_2160/']; 
...
% pick these points.
child.oceanPoint = [[100,100]; [NaN,NaN]; [NaN,NaN]; [NaN,NaN]; [200,400]];
